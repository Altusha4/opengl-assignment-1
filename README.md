...
| Sunset | Night |
|---|---|
| ![Sunset](practice_postcard/screenshot_sunset.png) | ![Night](practice_postcard/screenshot_night.png) |

### Technologies

* C++17, OpenGL 3.3 core profile
* GLFW for the window and keyboard input
* GLAD as the OpenGL function loader (generated code is in `practice_postcard/glad`)
* CMake for the build
...
The full report is in [`practice_postcard/README.md`](practice_postcard/README.md).
